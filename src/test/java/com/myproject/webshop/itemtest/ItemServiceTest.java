...
public class ItemServiceTest {
    ...
    public void setUp() {
        ...
        Item item = new Item();
       // Item item = new Item(itemDto.getId(), itemDto.getDescription(), itemDto.getPrice());
    ...
    public void updateItemTest() {
        ...
        ItemDto itemDto = new ItemDto("very nice", 99, "radio", "tehn", 165, "panasonic", 2 );
    ...
    public void findItemById() {
        ...
        Assert.assertEquals(199.99, dto.getPrice(), DELTA);
      // assertEquals((int) 5.0, int(5.0));
